...
We can then define the probability $p(x_{t+1}\verty_y)$ utilising the previous target $y_t$ can be defined as:

![equation](https://latex.codecogs.com/svg.latex?p(x_{t+1}|y_y)%20=%20N(x_{t+1}|\mu_t,%20\sigma_t,%20\rho_t)), for

![equation](https://latex.codecogs.com/svg.latex?N(x|\mu,%20\sigma,%20\rho)%20=%20{1\over{2\pi\sigma_1\sigma_2\sqrt{1-\rho^2}}}exp\big{[}{-Z\over{2(1-\rho^2})}\big{]}), with
...
![equation](https://latex.codecogs.com/svg.latex?{{%20%20\partial%20log%20N(x|\mu,\sigma,\rho)}\over{%20%20\partial%20\hat{\mu}_1}}%20=%20%20{{C}\over{\sigma_1}}\big{(}{{x_1%20-%20\mu_1}\over{\sigma_1}}%20-%20{{\rho(x_2%20-%20\mu_2)}\over{\sigma_2}}\big{)})

![equation](https://latex.codecogs.com/svg.latex?{{%20%20\partial%20log%20N(x|\mu,\sigma,\rho)}\over{%20%20\partial%20\hat{\mu}_2}}%20=%20%20{{C}\over{\sigma_1}}\big{(}{{x_2%20-%20\mu_2}\over{\sigma_2}}%20-%20{{\rho(x_1%20-%20\mu_1)}\over{\sigma_1}}\big{)})

![equation](https://latex.codecogs.com/svg.latex?{{%20%20\partial%20log%20N(x|\mu,\sigma,\rho)}\over{%20%20\partial%20\hat{\sigma}_1}}%20=%20%20%20{{C(x_1%20-%20\mu_1)}\over{\sigma_1}}%20%20\big{(}%20{{x_1%20-%20\mu_1}\over{\sigma_1}}%20-%20{{\rho(x_2-\mu_2)}\over{\sigma_2}}%20\big{)})

![equation](https://latex.codecogs.com/svg.latex?{{%20%20\partial%20log%20N(x|\mu,\sigma,\rho)}\over{%20%20\partial%20\hat{\sigma}_2}}%20=%20%20%20{{C(x_2%20-%20\mu_2)}\over{\sigma_2}}%20%20\big{(}%20{{x_2%20-%20\mu_2}\over{\sigma_2}}%20-%20{{\rho(x_1-\mu_1)}\over{\sigma_1}}%20\big{)})
